...
public class ResManager {
    ...
    public static String getStringSafely(int resId) {
        try {
    ...
    public static String getStringSafely(int resId, Object... formatArgs) {
        try {
    ...
    public static Drawable getDrawableForDensity(String packageName, int resourceId, int density) {
        ...
        try {
            PackageInfo packageInfo = getPackageInfoFromPackageName(getContext(), packageName);
